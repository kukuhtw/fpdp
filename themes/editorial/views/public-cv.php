...
<nav class="ed-nav"><a class="ed-brand" href="/">FPDP</a><div class="ed-nav-links"><a href="/@<?= rawurlencode((string) $profile['handle']) ?>">Profil</a><a href="/timeline">Timeline</a></div></nav>
<main class="ed-main">
