...
| Tests | 51 test scripts covering identity, content, payments (every gateway, refund, cancel, reconciliation), media upload, federation (ActivityPub discovery, signatures, inbox, outbox, mutual follows), marketplace, analytics, deployment config, and the installer — see `tests/` |
...
| Pengujian | 51 test script mencakup identity, konten, payment (semua gateway, refund, pembatalan, rekonsiliasi), upload media, federasi (discovery ActivityPub, signature, inbox, outbox, mutual follow), marketplace, analytics, config deployment, dan installer — lihat `tests/` |
