...
foreach ([
    ...
    'CREATE TABLE federated_posts (id INTEGER PRIMARY KEY, public_id TEXT, remote_actor_id INTEGER, object_uri TEXT, canonical_url TEXT, title TEXT, content TEXT, visibility TEXT, published_at TIMESTAMP, fetched_at TIMESTAMP, created_at TIMESTAMP, deleted_at TIMESTAMP)',
] as $sql) { $db->exec($sql); }
