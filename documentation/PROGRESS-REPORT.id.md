...
3. **Administration dashboard backend** — endpoint untuk settings, produk, order, payment, analitik (termasuk UI untuk endpoint moderasi federasi dan pengaturan gateway yang sudah ada di API).
